...
| # | Aksi | URL | Yang Dicek | Hasil Ekspektasi | ✓/✗ | Catatan |
|---|------|-----|------------|------------------|-----|---------|
| 3.1 | Cek notifikasi | `/warga/notifications` | Notif | "Laporan Perlu Revisi" + catatan ke-1 tampil | `[ ]` | |
| 3.2 | Buka detail laporan | `/warga/report-detail?id=...` | Status | "Perlu Revisi" | `[ ]` | |
| 3.3 | Cek catatan admin ke-1 tampil | - | 📋 Catatan | Teks catatan ke-1 tampil | `[ ]` | |
...
| 4.2 | Cek deskripsi sudah direvisi | - | 📋 Deskripsi | Konten revisi ke-1 tampil | `[ ]` | |
...
| 6.2 | Cek foto baru dari revisi ke-2 | - | 📋 Foto | Foto terbaru tampil | `[ ]` | |
...
| 6.5 | Admin dinas tugaskan petugas | Status = DITUGASKAN | `[ ]` |
