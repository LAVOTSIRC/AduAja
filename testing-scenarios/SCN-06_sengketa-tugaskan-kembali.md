...
**Prasyarat:** Ada 2 akun petugas di dinas yang sama.
...
| 1.4 | Admin dinas tugaskan petugas A | Status = Ditugaskan | `[ ]` |
...
| 2.5 | Upload foto bukti ketidakpuasan | - | Upload foto | Preview foto tampil | `[ ]` | |
...
| 2.8 | ⚠️ Coba ajukan sengketa lagi | POST dispute lagi | Error | Tidak bisa ajukan sengketa 2x pada laporan yang sama | `[ ]` | |
