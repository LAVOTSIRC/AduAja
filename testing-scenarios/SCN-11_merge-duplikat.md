...
| 1.3 | Cek keduanya di admin | `/admin/validation` | Kedua laporan tampil | Status keduanya = MENUNGGU_VALIDASI | `[ ]` | |
...
| 4.2 | Disposisi laporan A ke dinas | Hanya 1 disposisi (bukan 2) | `[ ]` |
| 4.3 | Admin dinas tugaskan petugas | 1 FieldTask untuk laporan A | `[ ]` |
| 4.4 | Petugas kerjakan → selesai | Status task = SELESAI | `[ ]` |
| 4.5 | Warga A konfirmasi | Status laporan A = **SELESAI** | `[ ]` |
